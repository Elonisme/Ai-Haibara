...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2024-03-01 20:03:10" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2024-03-01 20:03:10" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2024-03-01 20:03:10" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2024-03-01 20:03:10" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2024-03-01 20:03:10" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2024-03-01 20:03:10" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2024-03-01 20:03:10" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "lsp-bridge" ("2024-03-01 20:03:11" ("emacs" "markdown-mode") (:type git :host github :repo "manateelazycat/lsp-bridge" :files (:defaults "*.el" "*.py" "acm" "core" "langserver" "multiserver" "resources") :build (:not compile) :package "lsp-bridge" :local-repo "lsp-bridge")) "markdown-mode" ("2024-03-01 20:03:11" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "typst-mode" ("2024-03-01 20:03:11" ("polymode" "emacs") (:type git :host github :repo "Ziqi-Yang/typst-mode.el" :package "typst-mode" :local-repo "typst-mode.el")) "polymode" ("2024-03-01 20:03:11" ("emacs") (:type git :flavor melpa :host github :repo "polymode/polymode" :package "polymode" :local-repo "polymode")) "typst-ts-mode" ("2024-02-01 20:51:56" ("emacs") (:type git :host sourcehut :repo "meow_king/typst-ts-mode" :package "typst-ts-mode" :local-repo "typst-ts-mode")) "tree-sitter-langs" ("2024-02-01 20:42:58" ("emacs" "tree-sitter") (:type git :flavor melpa :files (:defaults "queries" "tree-sitter-langs-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/tree-sitter-langs" :package "tree-sitter-langs" :local-repo "tree-sitter-langs")) "tree-sitter" ("2024-02-01 20:42:34" ("emacs" "tsc") (:type git :flavor melpa :files (:defaults (:exclude "lisp/tree-sitter-tests.el") "tree-sitter-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/elisp-tree-sitter" :package "tree-sitter" :local-repo "elisp-tree-sitter")) "tsc" ("2024-02-01 20:42:33" ("emacs") (:flavor melpa :files ("core/*.el" "core/Cargo.toml" "core/Cargo.lock" "core/src" "tsc-pkg.el") :package "tsc" :local-repo "elisp-tree-sitter" :type git :repo "emacs-tree-sitter/elisp-tree-sitter" :host github :branch "release"))))
...
(fn &optional ARG)" t) (register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown")) (provide 'markdown-mode-autoloads)) "lsp-bridge" ((lsp-bridge-inlay-hint lsp-bridge-code-action lsp-bridge-dart lsp-bridge lsp-bridge-jdtls lsp-bridge-semantic-tokens lsp-bridge-ref lsp-bridge-epc lsp-bridge-org-babel lsp-bridge-call-hierarchy lsp-bridge-autoloads lsp-bridge-peek lsp-bridge-lsp-installer lsp-bridge-diagnostic) (autoload 'lsp-bridge-mode "lsp-bridge" "LSP Bridge mode.
